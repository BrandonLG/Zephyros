...
<model name="Control_PQ_V_1_0">
  <header formatversion="2" hwxversion="2019.3" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="Brandon"/>
      <property name="creationdate" value="03/31/20 01:00:46"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="03/31/20 01:05:20"/>
  ...
  <finalization/>
  <diagram>
    <block name="Volume vs time" type="block">
      ...
      <parameters>
        <section name="Main">
          ...
          <parameter name="winSize" value="[200;200]"/>
          <parameter name="winPos" value="[0;0]"/>
          <parameter name="winNam" value="&apos;Volume vs time&apos;"/>
    ...
    <block name="Ventilator" type="block">
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="M" value="2.5"/>
          <parameter name="F" value="1.57"/>
    ...
    <block name="Respiratory Mechanics&#xA;" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="165" y="-338"/>
        <size width="165" height="92"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">s²+420s&#xA;────────────&#xA;s²+620s+4000</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="num" value="[1,420,0]"/>
          <parameter name="den" value="[1,620,4000]"/>
        </section>
      </parameters>
    </block>
    <block name="Q vs time" type="block">
      <template name="system/SignalViewers/Scope"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="0"/>
      ...
      <parameters>
        <section name="Main">
          ...
          <parameter name="winSize" value="[200;200]"/>
          <parameter name="winPos" value="[0;0]"/>
          <parameter name="winNam" value="&apos;Q vs time&apos;"/>
          <parameter name="winHidden" value="1"/>
          <parameter name="showAtEnd" value="0"/>
          <parameter name="option" value="&apos;Reuse&apos;"/>
        </section>
    ...
    <block name="Pao vs time" type="block">
      <template name="system/SignalViewers/Scope"/>
      <properties>
        <property name="masked" value="1"/>
        <property name="inlinable" value="0"/>
      ...
      <parameters>
        <section name="Main">
          ...
          <parameter name="winSize" value="[200;200]"/>
          <parameter name="winPos" value="[0;0]"/>
          <parameter name="winNam" value="&apos;Pao vs time&apos;"/>
          <parameter name="winHidden" value="1"/>
          <parameter name="showAtEnd" value="0"/>
          <parameter name="option" value="&apos;Reuse&apos;"/>
        </section>
    ...
    <block name="Integrator" type="block">
    ...
    <block name="ToCSV" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="622.5905151367188" y="-411.6478576660156"/>
        <size width="100" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">file.csv</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <ports>
        <port name="&quot;PaO2&quot; &quot;VT&quot; &quot;Flux&quot;" type="variableport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Explicit"/>
            <property name="portnumber" value="nin"/>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="fname" value="&apos;C:&#x5C;Users&#x5C;Brandon&#x5C;Documents&#x5C;Respirador&#x5C;file.csv&apos;"/>
          <parameter name="nin" value="3"/>
          <parametertable name="inports">
            <columns number="2">
          ...
          <parameter name="quotedNames" value="0"/>
          <parameter name="externalActivation" value="0"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="422.59051513671875" y="-462"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="417.59051513671875" y="-242"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block_1" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="499.59051513671875" y="-307"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Integrator" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="430" y="-380.6666666666667"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Respiratory Mechanics&#xA;" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <to block="Integrator" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Ventilator" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="40" y="-403.3333333333333"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="_S_p_l_i_t_3" port="2" iotype="out"/>
      <to block="Respiratory Mechanics&#xA;" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="612.5905151367186" y="-424.5598449707031"/>
        <point x="422.59051513671875" y="-424.5598449707031"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Split" port="1" iotype="out"/>
      <to block="Pao vs time" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ToCSV" port="3" iotype="in"/>
      <to block="Block" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="612.5905151367188" y="-267.978515625"/>
        <point x="417.59051513671875" y="-267.97851562500006"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block" port="1" iotype="out"/>
      <to block="Q vs time" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ToCSV" port="2" iotype="in"/>
      <to block="Block_1" port="2" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="565.5905151367188" y="-391.6478576660156"/>
        <point x="565.5905151367188" y="-347.76519775390625"/>
        <point x="499.59051513671875" y="-347.76519775390625"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Block_1" port="1" iotype="out"/>
      <to block="Volume vs time" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points/>
    </link>
    <annotation name="Annotation Block" type="text">
      ...
      <rotate angle="0"/>
      <text font="Arial,10" color="0,0,0,255">Pao&#xA;</text>
    </annotation>
    <annotation name="Annotation Block_1" type="text">
      <frame shape="rectangle" visible="0" color="0,0,0,255" cornerradius="0" thickness="1.5"/>
      <background color="0,0,0,0"/>
      <position x="382" y="-223"/>
      <size width="30" height="28"/>
      <rotate angle="0"/>
      <text font="Arial,10" color="0,0,0,255">Q</text>
    </annotation>
    <context/>
    <graphics>
